...
<!-- Bootstrap core CSS -->
<link href="{{asset('assets/front/css/styles.min.css')}}" rel="stylesheet">
                            ...
                            <div class="blog-list-widget">
                                <div class="list-group">
                                    <a href="marketing-single.html"
                                        class="list-group-item list-group-item-action flex-column align-items-start">
                                        <div class="w-100 justify-content-between">
                                            <img src="{{asset('assets/front')}}/upload/small_01.jpg" alt=""
                                                class="img-fluid float-left">
                                    ...
                                    <a href="marketing-single.html"
                                        class="list-group-item list-group-item-action flex-column align-items-start">
                                        <div class="w-100 justify-content-between">
                                            <img src="{{asset('assets/front')}}/upload/small_02.jpg" alt=""
                                                class="img-fluid float-left">
                                    ...
                                    <a href="marketing-single.html"
                                        class="list-group-item list-group-item-action flex-column align-items-start">
                                        <div class="w-100 last-item justify-content-between">
                                            <img src="{{asset('assets/front')}}/upload/small_03.jpg" alt=""
                                                class="img-fluid float-left">
