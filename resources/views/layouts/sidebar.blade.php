            ...
            <div class="list-group">
                <a href="marketing-single.html"
                    ...
                    <div class="w-100 justify-content-between">
                        <img src="{{asset('assets/front')}}/upload/small_07.jpg" alt=""
                ...
                <a href="marketing-single.html"
                    class="list-group-item list-group-item-action flex-column align-items-start">
                    <div class="w-100 justify-content-between">
                        <img src="{{asset('assets/front')}}/upload/small_08.jpg" alt=""
                            class="img-fluid float-left">
                ...
                <a href="marketing-single.html"
                    ...
                    <div class="w-100 last-item justify-content-between">
                        <img src="{{asset('assets/front')}}/upload/small_09.jpg" alt=""
                            class="img-fluid float-left">
    ...
    <div id="" class="widget">
        ...
        <div class="banner-spot clearfix">
            <div class="banner-img">
                <img src="{{asset('assets/front')}}/upload/banner_03.jpg" alt=""
                    class="img-fluid">
            </div><!-- end banner-img -->
        </div><!-- end banner -->
    </div><!-- end widget -->
