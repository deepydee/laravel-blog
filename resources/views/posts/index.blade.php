    ...
    <div class="blog-custom-build">
        <div class="blog-box wow fadeIn">
            ...
            <div class="blog-meta big-meta text-center">
                ...
                <h4><a href="marketing-single.html" title="">You can learn how to make money
                        with your blog and videos</a></h4>
        ...
        <div class="blog-box wow fadeIn">
            <div class="post-media">
                <a href="marketing-single.html" title="">
                    <img src="{{asset('assets/front')}}/upload/market_blog_02.jpg" alt=""
                        class="img-fluid">
                    <div class="hovereffect">
                        <span></span>
                    </div>
        ...
        <div class="blog-box wow fadeIn">
            <div class="post-media">
                <a href="marketing-single.html" title="">
                    <img src="{{asset('assets/front')}}/upload/market_blog_03.jpg" alt=""
                        class="img-fluid">
                    <div class="hovereffect">
                        <span></span>
                    </div>
            ...
            <div class="blog-meta big-meta text-center">
                ...
                <h4><a href="marketing-single.html" title="">Ways to reach the world through
                        mobile phones</a></h4>
                <p>Aenean interdum arcu blandit, vehicula magna non, placerat elit. Mauris et
                    pharetratortor. Suspendissea sodales urna. In at augue elit. Vivamus
                    enimcerat elicerat eli nibh, maximus ac felis nec, maximus tempor odio.</p>
        ...
        <div class="blog-box wow fadeIn">
            <div class="post-media">
                <a href="marketing-single.html" title="">
                    <img src="{{asset('assets/front')}}/upload/market_blog_04.jpg" alt=""
                        class="img-fluid">
                    <div class="hovereffect">
                        <span></span>
                    </div>
        ...
        <div class="blog-box wow fadeIn">
            <div class="post-media">
                <a href="marketing-single.html" title="">
                    <img src="{{asset('assets/front')}}/upload/market_blog_05.jpg" alt=""
                        class="img-fluid">
                    <div class="hovereffect">
                        <span></span>
                    </div>
            ...
            <div class="blog-meta big-meta text-center">
                ...
                <h4><a href="marketing-single.html" title="">Ten golden rules to be followed for
                        a real team work</a></h4>
                <p>Aenean interdum arcu blandit, vehicula magna non, placerat elit. Mauris et
                    pharetratortor. Suspendissea sodales urna. In at augue elit. Vivamus
                    enimcerat elicerat eli nibh, maximus ac felis nec, maximus tempor odio.</p>
                <small><a href="marketing-category.html" title="">Technology</a></small>
        ...
        <div class="blog-box wow fadeIn">
            <div class="post-media">
                <a href="marketing-single.html" title="">
                    <img src="{{asset('assets/front')}}/upload/market_blog_06.jpg" alt=""
                        class="img-fluid">
                    <div class="hovereffect">
                        <span></span>
                    </div>
